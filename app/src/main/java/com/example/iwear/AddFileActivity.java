...
public class AddFileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewShowUploads = findViewById(R.id.text_view_showUploads);
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddFileActivity.this, "Upload is in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(AddFileActivity.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            }
    ...
    public void openImagesActivity() {
        Intent intent = new Intent(AddFileActivity.this, HomeFragment.class);
...
//                    }, 5000);
//
//                    Toast.makeText(AddFileActivity.this, "Upload successful", Toast.LENGTH_LONG).show();
//                    Upload upload = new Upload(editTextFileName.getText().toString().trim(),
